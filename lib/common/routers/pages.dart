...
class RoutePages {
  ...
  static List<GetPage> list = [
    ...
    GetPage(name: RouteNames.mySendFeed, page: () => const SendPostPage()),
    GetPage(
      name: RouteNames.postsPostsIndex,
      page: () => const PostsIndexPage(),
    ),
    GetPage(name: RouteNames.postsPostDetal, page: () => const PostDetalPage()),
    ...
    GetPage(
      name: RouteNames.systemRegisterSelectCountry,

...
Map<String, String> localeEn = {
  ...
  LocaleKeys.commonSelectTips: 'Select',
  LocaleKeys.commonMessageSuccess: '@method Success',
  LocaleKeys.commonMessageIncorrect: '@method Error',
  LocaleKeys.commonNext: 'Next',
  LocaleKeys.commonEdit: 'Edit',
  LocaleKeys.commonEditPlaceholder: 'Please enter',
  LocaleKeys.commonTakePhoto: 'Take photo',
  LocaleKeys.commonChooseFromAlbum: 'Choose from album',
  LocaleKeys.selectLanguage: 'Select language',
  LocaleKeys.selectCountry: 'Choose country',
  LocaleKeys.searchCountry: 'Search',

  // Login & Register - Common
  LocaleKeys.loginForgotPassword: 'Forgot password?',
  LocaleKeys.loginSignIn: 'Login',
  LocaleKeys.loginSignUp: 'Sign Up',

  // Register
  LocaleKeys.commonLanguage: 'Languages',
  LocaleKeys.phonePlaceholder: 'Enter phone number',
  LocaleKeys.verifyCode: 'Verification code',
  LocaleKeys.verifyPlaceHolder: 'Enter Code',
  ...
  LocaleKeys.agreeTerms: 'I have read and agree to',
  ...
  // Home
  LocaleKeys.certification: 'Elite Verification',
  LocaleKeys.safeDating: 'Security Auth',
  LocaleKeys.reliable: 'Real',
  LocaleKeys.viewNow: 'View now',
  LocaleKeys.tab_1: 'Recommendations',
  LocaleKeys.tab_2: 'Local',
  LocaleKeys.tab_3: 'New users',
  LocaleKeys.highlyTrustedMatch: 'High-trust match',
  LocaleKeys.qualification: '@size credentials verified',
  LocaleKeys.apply: 'Apply for Verification',
  LocaleKeys.improve: 'Improve my credentials',
  LocaleKeys.viewApplication: 'Apply to view report',
  LocaleKeys.sayHi: 'Say hi',
  LocaleKeys.tag1: 'Real-name',
  LocaleKeys.tag2: 'Occupation',
  LocaleKeys.tag3: 'Tax',
  LocaleKeys.tag4: 'Credit',

  // Messages
  LocaleKeys.message: 'Messages',
  LocaleKeys.search: 'Enter keywords',
  LocaleKeys.report: 'Apply for report',
  LocaleKeys.check: 'Apply to view',
  LocaleKeys.loveFourTitle1: 'Occupation Verification',
  LocaleKeys.loveFourTitle2: 'Personal Tax',
  LocaleKeys.loveFourTitle3: 'Personal Credit',
  LocaleKeys.content: 'Enter message',
  LocaleKeys.uploadReport: 'Upload Security Report',
  LocaleKeys.complete: 'Done',

  // Community
  LocaleKeys.circle: 'Community',
  LocaleKeys.hotTopic: 'Trending topics',
  LocaleKeys.post: 'Community',
  LocaleKeys.share: 'Share & Unwind',
  LocaleKeys.expand: 'Expand',
  LocaleKeys.collapse: 'Collapse',
  LocaleKeys.look: 'See others',
  LocaleKeys.follow: 'Follow',
  LocaleKeys.unfollow: 'Unfollow',
  LocaleKeys.sendFeed: 'Post an update',
  LocaleKeys.comment: 'Comment',

  // Community Detail
  LocaleKeys.detail: 'Details',
  LocaleKeys.reply: 'Reply',

  // Me
  LocaleKeys.userCenter: 'Profile',
  LocaleKeys.fans: 'Followers',
  ...
  LocaleKeys.showcaseWall: 'Showcase wall',
  ...
  LocaleKeys.personalityTags: 'Professional skills',
  LocaleKeys.identityVerification: 'Identity verification',
  LocaleKeys.man: 'Male',
  LocaleKeys.woman: 'Female',

  // Settings
  LocaleKeys.messageNotification: 'Notifications',
  LocaleKeys.locationService: 'Location services',
  LocaleKeys.personalizedRecommendation: 'For You',
